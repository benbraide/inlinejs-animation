...
exports.TransitionElementCompact = exports.TransitionElement = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const find_data_1 = require("../utilities/find-data");
const base_1 = require("./base");
const resolve_1 = require("../utilities/resolve");
class TransitionElement extends base_1.AnimationBaseElement {
    constructor() {
        super();
        this.data_ = null;
        this.extend_ = null;
...
], TransitionElement.prototype, "extend", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string', checkStoredObject: true })
], TransitionElement.prototype, "actor", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string', checkStoredObject: true })
], TransitionElement.prototype, "ease", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], TransitionElement.prototype, "duration", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], TransitionElement.prototype, "mode", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], TransitionElement.prototype, "repeats", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'string' })
], TransitionElement.prototype, "delay", void 0);
exports.TransitionElement = TransitionElement;
function TransitionElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(TransitionElement, 'transition');
}
