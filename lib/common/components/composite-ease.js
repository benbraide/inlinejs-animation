...
exports.CompositeEaseElementCompact = exports.CompositeEaseElement = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const ease_base_1 = require("./ease-base");
const composite_1 = require("../easing/composite");
class CompositeEaseElement extends ease_base_1.AnimationBaseEaseElement {
    constructor() {
        super();
        this.actor_ = new composite_1.CompositeAnimationEase([]);
...
exports.CompositeEaseElement = CompositeEaseElement;
function CompositeEaseElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(CompositeEaseElement, 'ease-composite');
}
exports.CompositeEaseElementCompact = CompositeEaseElementCompact;
