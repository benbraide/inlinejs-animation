...
export const BounceInAnimationEase = CreateAnimationEaseCallback('bounceIn', (_a) => {
...
export const BounceInOutAnimationEase = CreateAnimationEaseCallback('bounceInOut', (_a) => {
    var { fraction } = _a, rest = __rest(_a, ["fraction"]);
    if (fraction < 0.5) {
