...
export const CubicInAnimationEase = CreateAnimationEaseCallback('cubicIn', ({ fraction }) => Math.pow(fraction, 3));
...
export const CubicInOutAnimationEase = CreateAnimationEaseCallback('cubicInOut', ({ fraction }) => {
