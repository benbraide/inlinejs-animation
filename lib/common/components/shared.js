...
exports.AnimationSharedElementCompact = exports.AnimationShared = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const base_1 = require("./base");
class AnimationShared extends base_1.AnimationElement {
    constructor() {
        super();
...
], AnimationShared.prototype, "timeRelative", void 0);
exports.AnimationShared = AnimationShared;
function AnimationSharedElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationShared);
}
