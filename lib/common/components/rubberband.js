...
exports.AnimationRubberbandElementCompact = exports.AnimationRubberbandElement = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const scene_base_1 = require("./scene-base");
const rubberband_1 = require("../creators/rubberband");
class AnimationRubberbandElement extends scene_base_1.AnimationSceneBaseElement {
    constructor() {
        super();
        this.multiplier = 0;
    }
...
exports.AnimationRubberbandElement = AnimationRubberbandElement;
function AnimationRubberbandElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationRubberbandElement, 'animation-rubberband');
}
