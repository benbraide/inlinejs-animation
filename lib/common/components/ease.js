...
exports.EaseElementCompact = exports.Ease = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const ease_actor_1 = require("./ease-actor");
const resolve_1 = require("../utilities/resolve");
class Ease extends ease_actor_1.AnimationEaseActorElement {
    constructor() {
        super();
        this.name_ = '';
        this.expression = '';
...
function EaseElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(Ease);
}
