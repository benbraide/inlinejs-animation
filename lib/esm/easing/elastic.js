...
export const ElasticInAnimationEase = CreateAnimationEaseCallback('elasticIn', ({ fraction }) => {
...
export const ElasticInOutAnimationEase = CreateAnimationEaseCallback('elasticInOut', ({ fraction }) => {
