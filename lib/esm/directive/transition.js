...
import { FindComponentById, AddDirectiveHandler, CreateDirectiveHandlerCallback, EvaluateLater, GetGlobal, UseEffect, BindEvent, DefaultTransitionDelay, DefaultTransitionDuration, DefaultTransitionRepeats, ExtractDuration, IsObject } from "@benbraide/inlinejs";
...
function GetData({ componentId, component, contextElement, argOptions }) {
    ...
    if (!data || GetGlobal().IsNothing(data)) {
        ...
        (_d = (_c = (component || FindComponentById(componentId))) === null || _c === void 0 ? void 0 : _c.FindElementScope(contextElement)) === null || _d === void 0 ? void 0 : _d.SetData('transition', data);
    }
    return data;
}
