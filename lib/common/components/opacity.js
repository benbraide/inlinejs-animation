...
exports.AnimationOpacityElementCompact = exports.AnimationOpacity = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const personal_1 = require("./personal");
class AnimationOpacity extends personal_1.AnimationPersonalActorElement {
    constructor() {
        super();
        this.from = 0;
        this.to = 1;
...
exports.AnimationOpacity = AnimationOpacity;
function AnimationOpacityElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationOpacity);
}
