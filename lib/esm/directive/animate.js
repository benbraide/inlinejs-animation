...
import { FindComponentById, AddDirectiveHandler, CreateDirectiveHandlerCallback, GetGlobal, LazyCheck, DefaultTransitionDelay, DefaultTransitionDuration, DefaultTransitionRepeats, ResolveTransition, WaitTransition } from "@benbraide/inlinejs";
    ...
    let checkpoint = 0, bind = () => {
        ...
        let begin = (reverse) => {
            ...
            if (options.inner) {
                ...
                waitTransition(reverse, (_a = FindTransitionData({ componentId, contextElement })) === null || _a === void 0 ? void 0 : _a.target, () => repeat(options.alternate ? !reverse : reverse));
            }
        };
        let repeat = (reverse) => {
            var _a, _b;
