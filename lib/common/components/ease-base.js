...
class AnimationBaseEaseElement extends base_1.AnimationBaseElement {
    ...
    HandleElementScopeCreated_(_a, postAttributesCallback) {
        ...
        scope.AddUninitCallback(() => { var _a; return this.name_ && ((_a = (0, inlinejs_1.GetGlobal)().GetConcept('animation')) === null || _a === void 0 ? void 0 : _a.GetEaseCollection().Remove(this.name_)); });
    }
}
__decorate([
