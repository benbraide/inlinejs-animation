...
exports.AnimateContentElementCompact = exports.AnimateContent = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const base_1 = require("./base");
class AnimateContent extends base_1.AnimationElement {
    constructor() {
        super();
        this.overlap = 1;
    ...
    WaitTransition({ componentId, callback, onAbort, reverse }) {
        ...
        let waitAbort = null, waitTarget = (target, alternated) => {
            ...
            return (0, inlinejs_1.WaitTransition)({ componentId, target, reverse: (alternated ? !reverse : reverse),
                callback: (waited) => {
                    if (reset) {
...
], AnimateContent.prototype, "overlap", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], AnimateContent.prototype, "alternate", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], AnimateContent.prototype, "reset", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], AnimateContent.prototype, "sequence", void 0);
__decorate([
    (0, inlinejs_element_1.Property)({ type: 'boolean' })
], AnimateContent.prototype, "reverse", void 0);
exports.AnimateContent = AnimateContent;
function AnimateContentElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimateContent);
}
exports.AnimateContentElementCompact = AnimateContentElementCompact;
