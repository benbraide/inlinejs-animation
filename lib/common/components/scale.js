...
exports.AnimationScaleElementCompact = exports.AnimationScale = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const generic_1 = require("../actors/scale/generic");
const personal_1 = require("./personal");
class AnimationScale extends personal_1.AnimationPersonalActorElement {
    constructor() {
        super();
        this.axis = 'both';
        this.from = '';
...
exports.AnimationScale = AnimationScale;
function AnimationScaleElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationScale);
}
