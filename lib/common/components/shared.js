...
exports.AnimationSharedElementCompact = exports.AnimationSharedElement = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const actor_base_1 = require("./actor-base");
class AnimationSharedElement extends actor_base_1.AnimationBaseActorElement {
    constructor() {
        super();
    ...
    Handle(_a) {
        ...
        if (actor) {
            ...
            (0, inlinejs_1.JournalTry)(() => (actor && ((typeof actor === 'function') ? actor(params) : actor.Handle(params))));
        }
    }
...
exports.AnimationSharedElement = AnimationSharedElement;
function AnimationSharedElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationSharedElement, 'animation-shared');
}
exports.AnimationSharedElementCompact = AnimationSharedElementCompact;
