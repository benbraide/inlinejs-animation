...
exports.AnimationVibrateElementCompact = exports.AnimationVibrate = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const vibrate_1 = require("../actors/scene/vibrate");
const scene_base_1 = require("./scene-base");
class AnimationVibrate extends scene_base_1.AnimationSceneBaseElement {
    constructor() {
        super();
    }
    CreateActor_() {
...
exports.AnimationVibrate = AnimationVibrate;
function AnimationVibrateElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationVibrate);
}
