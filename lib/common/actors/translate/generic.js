...
exports.CreateTranslateAnimationActor = exports.CreateTranslateAnimationCallback = exports.ComputeField = exports.DefaultTranslateAnimationActorUnit = exports.DefaultTranslateAnimationActorFactor = void 0;
...
function CreateTranslateAnimationCallback({ axis, factor, from, to, offset, unit } = {}) {
    ...
    const xUnit = (GetStringEntry(0, unit) || exports.DefaultTranslateAnimationActorUnit), yUnit = (GetStringEntry(1, unit) || exports.DefaultTranslateAnimationActorUnit);
    if (Array.isArray(from) && Array.isArray(to)) {
        ...
        const validFactors = [(factor[0] || exports.DefaultTranslateAnimationActorFactor), (factor[1] || exports.DefaultTranslateAnimationActorFactor)];
        computeDelta = (fraction) => {
            return [
        ...
        const validFactor = (factor || exports.DefaultTranslateAnimationActorFactor);
        computeDelta = (fraction) => {
