...
export declare class AnimationConcurrent extends AnimationElement implements IAnimationActor {
    private actor_;
    constructor();
    GetName(): string;
...
export declare function AnimationConcurrentElementCompact(): void;
