...
exports.SharedCompositeAnimationActor = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
class SharedCompositeAnimationActor {
    ...
    Handle(_a) {
        ...
        (0, inlinejs_1.JournalTry)(() => ((typeof info.actor === 'function') ? info.actor(params) : info.actor.Handle(params)));
    }
    AddActor(actor) {
...
exports.SharedCompositeAnimationActor = SharedCompositeAnimationActor;
