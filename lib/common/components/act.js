...
exports.AnimationSceneActElementCompact = exports.AnimationSceneAct = void 0;
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const generic_1 = require("../actors/scene/generic");
const base_1 = require("./base");
class AnimationSceneAct extends base_1.AnimationElement {
    constructor() {
        super();
        this.id_ = '';
...
exports.AnimationSceneAct = AnimationSceneAct;
function AnimationSceneActElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationSceneAct);
}
