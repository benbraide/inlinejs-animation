...
exports.AnimateContentElementCompact = exports.AnimateContentElement = void 0;
const inlinejs_1 = require("@benbraide/inlinejs");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const base_1 = require("./base");
class AnimateContentElement extends base_1.AnimationBaseElement {
    constructor() {
        super();
        this.overlap = 1;
...
exports.AnimateContentElement = AnimateContentElement;
function AnimateContentElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimateContentElement, 'animate-content');
}
