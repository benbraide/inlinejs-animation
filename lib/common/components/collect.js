...
exports.AnimationCollectElementCompact = exports.AnimationCollectElement = void 0;
const concurrent_1 = require("../actors/composite/concurrent");
const inlinejs_element_1 = require("@benbraide/inlinejs-element");
const actor_base_1 = require("./actor-base");
class AnimationCollectElement extends actor_base_1.AnimationBaseActorElement {
    constructor() {
        super();
...
exports.AnimationCollectElement = AnimationCollectElement;
function AnimationCollectElementCompact() {
    (0, inlinejs_element_1.RegisterCustomElement)(AnimationCollectElement, 'animation-collect');
}
