...
export const BackInAnimationEase = CreateAnimationEaseCallback('backIn', ({ fraction }) => ((2.70158 * fraction * fraction * fraction) - (1.70158 * fraction * fraction)));
...
export const BackInOutAnimationEase = CreateAnimationEaseCallback('backInOut', ({ fraction }) => {
    const c1 = 1.70158;
    const c2 = c1 * 1.525;
